        ...
        <form action="?m=server&a=add_server" method="POST">
            <table id="myListTable" class="tablesorter" border="0" cellpadding="0" cellspacing="1" style="margin: 0 auto;margin-top: 10px;margin-bottom: 20px;width:98%;">
                <tbody><tr>
                        ...
                        <td><input type="text" id="server_name" name="server_name" value="<?php echo ($server["server_name"]); ?>" />
                            <span class="require-field">*</span></td>
                    </tr>
                    <tr>
                        <td align="left" class="td_left">服务器地址(IP)：</td>
                        <td><input type="text" id="server_ip" name="server_ip" maxlength="15" value="<?php echo ($server["server_ip"]); ?>"/>
                            <span class="require-field">*格式(192.168.123.321)</span>
                        </td>
                    </tr>
                    <tr>
                        <td align="left" class="td_left">服务器类型：</td>
                        <td><?php echo ($server_type); ?>
                            <span class="require-field">*</span></td>
                    </tr>
                    <tr>
                        <td align="left" class="td_left">服务器站点：</td>
                        <td><?php echo ($server_site); ?>
                            <span class="require-field">*</span></td>
                    </tr>
                    <tr>
                        <td align="left" class="td_left">服务器状态：</td>
                        <td><?php echo ($server_status); ?>
                            <span class="require-field">*</span></td>
                    </tr>
                    <tr>
                        <td align="left" class="td_left">服务器信息：</td>
                        <td><textarea class="txtarea " id="server_info" name="server_info" style="width:250px; height:100px;"><?php echo ($server["server_info"]); ?></textarea></td>
                    </tr>
                    <tr>
                        <td align="left" class="td_left">备注：</td>
                        <td><textarea class="txtarea " id="server_remark" name="server_remark" style="width:250px; height:50px;"><?php echo ($server["server_remark"]); ?></textarea></td>
                    </tr>
                </tbody>
                <tfoot>
                    <tr>
