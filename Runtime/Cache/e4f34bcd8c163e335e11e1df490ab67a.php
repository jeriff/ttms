...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <form action="?m=question&a=insert" method="POST"  enctype="multipart/form-data">
                ...
                <tbody>
                    ...
                    <tr>
                     ...
                     <tr>
                        ...
                        <td>报告时间</td>
                        <td><input type="text" class="Wdate" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'});" id="report_date" name="report_date" value=""/></td>
                    </tr>
                     <tr>
                        <td>报告人</td>
                        <td><input type="text" name="report_user"></td>
                         <td>产生工时（时）</td>
                        <td><input type="text" name="process_time">(时)</td>
                    </tr>
                     <tr>
                        <td>事件内容</td>
                        <td><textarea name="question_contetn"></textarea></td>
                        <td>影响</td>
                        <td><textarea name="affect"></textarea></td>
                    </tr>
                     <tr>
                        <td>原因</td>
                        <td><textarea name="reason"></textarea></td>
                        <td>对策</td>
                        <td><textarea name="countermeasure"></textarea></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>处理时间</td>
                        <td><input type="text" class="Wdate" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'});" id="time" name="time" value=""/></td>
                    </tr>
                    <tr>
                        <td>上传证据</td>
                ...
                <tfoot>
                    <tr>
                        <td colspan="4" align="center">
                            ...
                            <input type="button" value="返回" class="btncancel" />
                        </td>
                    </tr>
                </tfoot>
